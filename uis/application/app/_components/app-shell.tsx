/**
 * NEXOVA SOLUTIONS - application/_components/app-shell.tsx
 * Chrome de la aplicación de operaciones: barra lateral en escritorio, barra
 * superior en móvil. Envuelve todas las páginas desde el root layout. Server component.
 */
